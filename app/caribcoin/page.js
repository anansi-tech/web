        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 pt-40 pb-20 relative">
          ...
          <div className="reveal">
            ...
            <p className="text-[18px] text-anansi-gray mt-8 max-w-[620px] leading-[1.75]">
              ...
              value from real economic activity — not promises. Fixed supply. Deflationary burns.
              Open ecosystem. Open to anyone.
            </p>
          </div>
        </div>
      </section>
              ...
              {[
                {
                  ...
                  body: "Spice charges 1% on surplus distribution and 0.5% on buyer swaps. Each future Anansi product — DollarBank, CaribStone, SaaS — adds its own fee surface. Every fee event feeds the same flywheel.",
                },
                {
            ...
            <div className="flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="grid grid-cols-3 gap-6 mt-10 pt-8 border-t border-anansi-line">
                  {[
                    { label: "Spice (live)", fee: "0.5% – 1%" },
                    { label: "DollarBank", fee: "Coming" },
                    { label: "CaribStone", fee: "Coming" },
                  ].map((f, i) => (
                    <div key={i}>
      ...
      <section className="max-w-[1200px] mx-auto px-6 md:px-12 py-24">
        <div className="reveal">
          ...
          <p className="text-anansi-gray max-w-[620px] mb-12 leading-relaxed">
            Staking CARIB unlocks four tiers of platform benefits — discounts, governance, priority
            access, airdrops. No fixed lock periods. No slashing. Unstake any time with a 24-hour
            cooldown. The protocol does not pay yield — it unlocks access.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Stake ≥ 1,000 CARIB (Tier 1) to vote on protocol parameters: fee rates, burn ratio, new asset approvals, treasury spending.",
              tier: "1K CARIB",
            },
            {
              title: "Reduced fees",
              desc: "Stake ≥ 5,000 CARIB (Tier 2) for 25% off Spice swap fees. Stake ≥ 10,000 CARIB (Tier 3) for 50% off. Discounts extend to every future Anansi product.",
              tier: "5K – 10K CARIB",
            },
            {
              title: "Priority access",
              desc: "Stake ≥ 50,000 CARIB (Tier 4) for early access to new asset pools before public availability — alongside the maximum fee discount.",
              tier: "50K CARIB",
            },
            {
