          ...
          >
            ...
            <g transform="translate(0 -134)">
              <g className="hero-web-layer">
                <path
                  d="M 156 252 L 286 348 L 420 486 L 592 474 L 776 536"
                  className="hero-web-line hero-web-line-fine"
                />
                <path
                  d="M 226 146 L 286 348 L 420 486 L 520 660 L 754 738"
                  className="hero-web-line hero-web-line-soft"
                />
                <path d="M 154 560 L 420 486 L 592 474 L 754 738" className="hero-web-line" />
                <path
                  d="M 172 738 L 314 700 L 520 660 L 754 738"
                  className="hero-web-line hero-web-line-soft"
                />
                <path d="M 286 348 L 314 700" className="hero-web-line hero-web-line-fine" />
                <path d="M 420 486 L 314 700" className="hero-web-line hero-web-line-diag-soft" />
                <path d="M 420 486 L 520 660" className="hero-web-line hero-web-line-diag" />
                <path
                  d="M 592 474 L 748 404 L 850 410"
                  className="hero-web-line hero-web-line-soft"
                />
                <path d="M 776 536 L 850 410" className="hero-web-line hero-web-line-fine" />
                <path d="M 754 738 L 892 670" className="hero-web-line hero-web-line-fine" />

                <path
                  d="M 1764 252 L 1634 348 L 1500 486 L 1328 474 L 1144 536"
                  className="hero-web-line hero-web-line-fine"
                />
                <path
                  d="M 1694 146 L 1634 348 L 1500 486 L 1400 660 L 1166 738"
                  className="hero-web-line hero-web-line-soft"
                />
                <path d="M 1766 560 L 1500 486 L 1328 474 L 1166 738" className="hero-web-line" />
                <path
                  d="M 1748 738 L 1606 700 L 1400 660 L 1166 738"
                  className="hero-web-line hero-web-line-soft"
                />
                <path d="M 1634 348 L 1606 700" className="hero-web-line hero-web-line-fine" />
                <path d="M 1500 486 L 1606 700" className="hero-web-line hero-web-line-diag-soft" />
                <path d="M 1500 486 L 1400 660" className="hero-web-line hero-web-line-diag" />
                <path
                  d="M 1328 474 L 1172 404 L 1070 410"
                  className="hero-web-line hero-web-line-soft"
                />
                <path d="M 1144 536 L 1070 410" className="hero-web-line hero-web-line-fine" />
                <path d="M 1166 738 L 1028 670" className="hero-web-line hero-web-line-fine" />

                <path
                  d="M 154 560 L 314 700 L 520 660"
                  className="hero-web-line hero-web-line-diag-soft"
                />
                <path
                  d="M 1766 560 L 1606 700 L 1400 660"
                  className="hero-web-line hero-web-line-diag-soft"
                />
                <path
                  d="M 226 146 L 420 178 L 748 196 L 1038 204"
                  className="hero-web-line hero-web-line-soft"
                />
                <path
                  d="M 1694 146 L 1500 178 L 1172 196 L 882 204"
                  className="hero-web-line hero-web-line-soft"
                />

                <circle cx="226" cy="146" r="1.8" className="hero-web-node hero-web-node-soft" />
                <circle cx="286" cy="348" r="2.1" className="hero-web-node" />
                <circle cx="314" cy="700" r="1.9" className="hero-web-node hero-web-node-soft" />
                <circle cx="420" cy="486" r="2.1" className="hero-web-node" />
                <circle cx="520" cy="660" r="1.9" className="hero-web-node hero-web-node-soft" />
                <circle cx="592" cy="474" r="1.8" className="hero-web-node hero-web-node-soft" />
                <circle cx="748" cy="404" r="1.8" className="hero-web-node hero-web-node-soft" />
                <circle cx="776" cy="536" r="2.1" className="hero-web-node" />
                <circle cx="754" cy="738" r="1.8" className="hero-web-node hero-web-node-soft" />
                <circle cx="1634" cy="348" r="2.1" className="hero-web-node" />
                <circle cx="1606" cy="700" r="1.9" className="hero-web-node hero-web-node-soft" />
                <circle cx="1500" cy="486" r="2.1" className="hero-web-node" />
                <circle cx="1400" cy="660" r="1.9" className="hero-web-node hero-web-node-soft" />
                <circle cx="1328" cy="474" r="1.8" className="hero-web-node hero-web-node-soft" />
                <circle cx="1172" cy="404" r="1.8" className="hero-web-node hero-web-node-soft" />
                <circle cx="1144" cy="536" r="2.1" className="hero-web-node" />
                <circle cx="1166" cy="738" r="1.8" className="hero-web-node hero-web-node-soft" />
                <circle cx="1694" cy="146" r="1.8" className="hero-web-node hero-web-node-soft" />
              </g>
